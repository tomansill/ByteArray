...
public interface ReadOnlyByteArray extends ByteArray{
  ...
  /**
   * Reads a short at a specified index on this {@link ReadOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return short value using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
  ...
  /**
   * Reads a short at a specified index on this {@link ReadOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return short value using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully extracted as it goes over the length of the byte array
   */
  ...
  /**
   * Reads an int at a specified index on this {@link ReadOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return int value using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully extracted as it goes over the length of the byte array
   */
  ...
  /**
   * Reads an int at a specified index on this {@link ReadOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return int value using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully extracted as it goes over the length of the byte array
   */
  ...
  /**
   * Reads a long at a specified index on this {@link ReadOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return long value using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully extracted as it goes over the length of the byte array
   */
  ...
  /**
   * Reads a long at a specified index on this {@link ReadOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return long value using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully extracted as it goes over the length of the byte array
   */
  ...
  /**
   * Reads a float at a specified index on this {@link ReadOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return float value using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully extracted as it goes over the length of the byte array
   */
  ...
  /**
   * Reads a float at a specified index on this {@link ReadOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return float value using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully extracted as it goes over the length of the byte array
   */
  ...
  /**
   * Reads a double at a specified index on this {@link ReadOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return double value using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully extracted as it goes over the length of the byte array
   */
  ...
  /**
   * Reads a double at a specified index on this {@link ReadOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link ReadOnlyByteArray}
   * @return double value using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully extracted as it goes over the length of the byte array
   */
  ...
  /**
   * Copies bytes from this {@link ReadOnlyByteArray} starting at specified byte index and writes the bytes to destination {@link WriteOnlyByteArray}.
   *
   * @param byteIndex   non-negative index on this {@link ReadOnlyByteArray}
   ...
   */
  default void copyTo(@Nonnegative long byteIndex, @Nonnull WriteOnlyByteArray destination)
  throws ByteArrayIndexOutOfBoundsException, ByteArrayLengthOverBoundsException{
