...
public interface WriteOnlyByteArray extends ByteArray{
  ...
  /**
   * Writes a short at a specified byte index on this {@link WriteOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     short value to be written to this {@link WriteOnlyByteArray} using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
  ...
  /**
   * Writes a short at a specified byte index on this {@link WriteOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     short value to be written to this {@link WriteOnlyByteArray} using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully written as it goes over the length of the byte array
   */
  ...
  /**
   * Writes an int at a specified byte index on this {@link WriteOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     int value to be written to this {@link WriteOnlyByteArray} using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully written as it goes over the length of the byte array
   */
  ...
  /**
   * Writes an int at a specified byte index on this {@link WriteOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     int value to be written to this {@link WriteOnlyByteArray} using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully written as it goes over the length of the byte array
   */
  ...
  /**
   * Writes a long at a specified byte index on this {@link WriteOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     long value to be written to this {@link WriteOnlyByteArray} using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully written as it goes over the length of the byte array
   */
  ...
  /**
   * Writes a long at a specified byte index on this {@link WriteOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     long value to be written to this {@link WriteOnlyByteArray} using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully written as it goes over the length of the byte array
   */
  ...
  /**
   * Writes a float at a specified byte index on this {@link WriteOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     float value to be written to this {@link WriteOnlyByteArray} using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully written as it goes over the length of the byte array
   */
  ...
  /**
   * Writes a float at a specified byte index on this {@link WriteOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     float value to be written to this {@link WriteOnlyByteArray} using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully written as it goes over the length of the byte array
   */
  ...
  /**
   * Writes a double at a specified byte index on this {@link WriteOnlyByteArray} using big endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     double value to be written to this {@link WriteOnlyByteArray} using big endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully written as it goes over the length of the byte array
   */
  ...
  /**
   * Writes a double at a specified byte index on this {@link WriteOnlyByteArray} using little endian byte order
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   * @param value     double value to be written to this {@link WriteOnlyByteArray} using little endian byte order
   * @throws ByteArrayIndexOutOfBoundsException thrown if byteIndex is out of bounds
   * @throws ByteArrayLengthOverBoundsException thrown if the value cannot be fully written as it goes over the length of the byte array
   */
  ...
  /**
   * Copies bytes from source {@link ReadOnlyByteArray} to this {@link WriteOnlyByteArray} starting at specified byte index on {@link WriteOnlyByteArray}
   *
   * @param byteIndex non-negative index on this {@link WriteOnlyByteArray}
   ...
   */
  default void copyFrom(@Nonnegative long byteIndex, @Nonnull ReadOnlyByteArray source)
  throws ByteArrayIndexOutOfBoundsException, ByteArrayLengthOverBoundsException{
